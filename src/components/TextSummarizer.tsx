...
import { 
  ...
  TrendingDown, AlignLeft, AlertCircle, Clock, Hash, BookOpen, Loader2
} from "lucide-react";
...
export default function TextSummarizer({ provider, model }: TextSummarizerProps) {
  ...
  const handleSummarize = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    setLoadingStep(inputType === "url" ? "Mengunduh konten halaman web..." : "Membaca isi teks dokumen...");
      ...
      <div className="bg-[#1e1f20] rounded-2xl border border-[#2d2f31]/50 p-6 shadow-xl">
        ...
        <div className="flex border-b border-[#2d2f31]/60 mb-6">
          <button
            ...
            className={`flex items-center gap-2 pb-3 px-4 text-xs font-semibold border-b-2 transition-all -mb-px ${
              inputType === "text"
